class Admin::CustomersController < ApplicationController
  ...
  private
    ...
    def admin_customer_params
      params.require(:admin_customer).permit(:last_name, :first_name, :furigana_last_name, :furigana_first_name, :gender, :birth, :home_phone, :mobile_phone, :postal_code, :prefecture, :city, :street, :email)
    end
end
