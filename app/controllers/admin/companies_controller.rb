class Admin::CompaniesController < ApplicationController
  ...
  private
    ...
    def admin_company_params
      params.require(:admin_company).permit(:name, :main_phone, :inquiry_phone, :postal_code, :prefecture, :city, :street, :email, :license_number, :open_time, :end_time, :regular_holiday)
    end
end
