...
ActiveRecord::Schema.define(version: 20171128022457) do
  ...
  create_table "admin_property_adresses", force: :cascade do |t|
  ...
  create_table "admin_property_areas", force: :cascade do |t|
    t.integer "property_id"
  ...
  create_table "admin_property_details", force: :cascade do |t|
    t.integer "property_id"
    t.integer "price"
  ...
  create_table "admin_property_infos", force: :cascade do |t|
  ...
  create_table "admin_property_layouts", force: :cascade do |t|
    t.integer "property_id"
    t.string "floor_plan"
    t.integer "room"
  ...
  create_table "admin_property_traffics", force: :cascade do |t|
    t.integer "property_id"
